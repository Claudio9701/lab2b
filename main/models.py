...
class Producto(models.Model):
    ...
    def sku(self):
        codigo_categoria = self.categoria.codigo.zfill(4) # DEP -> 0DEP
        codigo_producto = str(self.id).zfill(6) # 1 -> 000001

        return f'{codigo_categoria}-{codigo_producto}' # 0DEP-000001
